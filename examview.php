...
if(isset($_SESSION['userid']))
{
	...
	{
		$resultac = mysqli_query($conn, "SELECT * FROM examination");
		echo	mysqli_num_rows($resultac);
	}
	else
	{
		$result = mysqli_query($conn, "SELECT * FROM examination LIMIT $_GET[first] , $_GET[last]");
	}
$result1 = mysqli_query($conn, "SELECT * FROM course LIMIT $_GET[first] , $_GET[last]");
//$result2 = mysql_query($conn, "SELECT * FROM subject");
?>
