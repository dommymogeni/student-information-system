...
{
$result2 = mysqli_query($conn, "SELECT DISTINCT courseid FROM subjects where courseid='$_SESSION[coid]'");
}
else
{
$result2 = mysqli_query($conn, "SELECT * courseid FROM subjects");	
}
?>
<script>
...
<table width="60%" border="0" cellspacing="0" cellpadding="0">
  ...
  {
	  $result21 = mysqli_query($conn, "SELECT * FROM course where courseid='$row1[courseid]'");
