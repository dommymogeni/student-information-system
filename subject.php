...
if($_GET['view'] = "delete"){
mysqli_query($conn, 'DELETE FROM subjects WHERE subid ="$_GET["slid"]"');
}
...
$result = mysqli_query($conn, "SELECT * FROM subjects LIMIT $_GET[first] , $_GET[last]");
$result1 = mysqli_query($conn, "SELECT * FROM course LIMIT $_GET[first] , $_GET[last]");
$reslec = mysqli_query($conn, "SELECT * FROM lectures LIMIT $_GET[first] , $_GET[last]");
?>
