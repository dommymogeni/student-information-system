...
{
mysqli_query($conn, "UPDATE studentdetails SET studfname='$_POST[studfname]', studlname='$_POST[studlname]', 	dob='$dbda', 	fathername='$_POST[fathername]', address='$_POST[address]', 		contactno='$_POST[contactno]', 	courseid='$_POST[courseid]', 	semester='$_POST[semester]' WHERE studid = '$_POST[studid]'");
...
{
$result = mysqli_query($conn, "SELECT * FROM studentdetails where studid='$_GET[slid]'");	
