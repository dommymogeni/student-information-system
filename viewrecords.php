...
<?php
  if($_GET["view"]="course")
  {
    ...
    $result = mysqli_query($conn, "SELECT * FROM course where courseid='$_GET[slid]'");
...
<?php }//course ends here ?>  
      
      
<?php
if($_GET["view"]="subject"){
  // Subject table starts here
  $result1 = mysqli_query($conn, "SELECT * FROM subject where subid='$_GET[slid]'");
...
$result2 = mysqli_query($conn, "SELECT * FROM lectures where lecid='$_GET[slid]'");
while($row2 = mysqli_fetch_array($result2))
  {
 $lecid =  $row2["lecid"];
 $password = $row2["l_password"];
...
$result3 = mysqli_query($conn, "SELECT * FROM studentdetails where studid='$_GET[slid]'");
...
$result6 = mysqli_query($conn, "SELECT * FROM administrator where adminid='$_GET[slid]'");
while($row6 = mysqli_fetch_array($result6))
  {
 $adminid =  $row6["adminid"];
 $password = $row6["a_password"];
