...
if($_GET["view"] = "delete")
{
  mysqli_query($conn, "DELETE FROM studentdetails WHERE studid ='$_GET[slid]'");
}
...
if(isset($_SESSION["userid"]))
{
	...
	{
		$result = mysqli_query($conn, "SELECT * FROM studentdetails where courseid='$_POST[courseid]' && semester='$_POST[semester]'");
	}
	else
	{
$result = mysqli_query($conn, "SELECT * FROM studentdetails LIMIT $_GET[first] , $_GET[last]");
	}

$result1= mysqli_query($conn, "SELECT * FROM course LIMIT $_GET[first] , $_GET[last]");
?>
<section id="page">
